...
time and product bundle ID. That object is a historical observation; it does
not turn the read-only status call into a claim about current ScreenCaptureKit
readiness.
